...
export default function FloatingWhatsApp({ phone }: { phone: string }) {
  return (
    <a
      ...
      className="wa-pulse fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] shadow-lg shadow-black/40 transition-transform hover:scale-110"
    >
